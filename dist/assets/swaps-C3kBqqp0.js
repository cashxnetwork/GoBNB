import{a as A,r as U,p as _,v as i,N as D,x as u,e as V,k as W,R as $,j as M,M as K,A as L,W as F,f as Q,m as q}from"./index-BPJk4_X_.js";import{r as s,n as w,c as C,U as x}from"./if-defined-2I7sZTdO.js";import"./index-B0iElh5U.js";import{M as R}from"./index-Ca0sJvji.js";import"./index-C7IxDbeT.js";import"./index-DcRpPBHv.js";import"./index-BtWQwpcd.js";import"./index-BeGSVlA5.js";import"./index-BUnCAm7T.js";import"./index-tlwsXAFO.js";import"./index-B_DM0r68.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
