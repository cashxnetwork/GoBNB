import{a as A,r as U,p as _,v as i,N as D,x as u,e as V,k as W,R as $,j as M,M as K,A as L,W as F,f as Q,m as q}from"./index-C7cBUxcm.js";import{r as s,n as w,c as C,U as x}from"./if-defined-BZZvwuus.js";import"./index-C_mUWead.js";import{M as R}from"./index-wU5ECD_J.js";import"./index-DOBT13-6.js";import"./index-B70JzZ_T.js";import"./index-BATWy8RJ.js";import"./index-Ctux_Cuu.js";import"./index-C4ysMPVG.js";import"./index-KuZ4KIt7.js";import"./index-1n0bcWj9.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
