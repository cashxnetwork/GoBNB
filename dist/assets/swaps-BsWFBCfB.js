import{a as A,r as U,p as _,v as i,N as D,x as u,e as V,k as W,R as $,j as M,M as K,A as L,W as F,f as Q,m as q}from"./index-DCOE1VSz.js";import{r as s,n as w,c as C,U as x}from"./if-defined-DzqSVOda.js";import"./index-B_rxQ9Bx.js";import{M as R}from"./index-Cp05Jb9h.js";import"./index-B9rb1Pbr.js";import"./index-rett59wJ.js";import"./index-1KDx_-KU.js";import"./index-CTsEoO24.js";import"./index-Rbcl__tY.js";import"./index-BAFLfvh4.js";import"./index-BSgiQW5g.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
