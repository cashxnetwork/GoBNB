import{a as A,r as U,p as _,v as i,N as D,x as u,e as V,k as W,R as $,j as M,M as K,A as L,W as F,f as Q,m as q}from"./index-CanoT5qk.js";import{r as s,n as w,c as C,U as x}from"./if-defined-IeYUFoci.js";import"./index-CzyXoJ4h.js";import{M as R}from"./index-B9tduY2P.js";import"./index-qY3kdG1e.js";import"./index-CkKgPVbm.js";import"./index-C_mv2aWo.js";import"./index-d1Ew2TpS.js";import"./index-B614hOOK.js";import"./index-C-uC0n8x.js";import"./index-B6HHJ6QE.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
