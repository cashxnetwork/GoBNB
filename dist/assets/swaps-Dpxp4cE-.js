import{a as A,r as U,p as _,v as i,N as D,x as u,e as V,k as W,R as $,j as M,M as K,A as L,W as F,f as Q,m as q}from"./index-DGuh_UAF.js";import{r as s,n as w,c as C,U as x}from"./if-defined-D7Br8_19.js";import"./index-RAMl2baY.js";import{M as R}from"./index-DHQUJnZa.js";import"./index-CszWJ-sL.js";import"./index-mOGXlAbv.js";import"./index-CgXvtImq.js";import"./index-DFcf_PpA.js";import"./index-CZ7GE8BO.js";import"./index-XejPdjzb.js";import"./index-fm6M8FIG.js";const G={numericInputKeyDown(l,t,e){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&l.preventDefault(),t==="0"&&B&&(e(o),l.preventDefault()),(E||O)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!B&&!n.includes(o)&&!O&&!E&&l.preventDefault()}},H=A`
  :host {
    width: 100%;
  }
