import{z as re,B as J,D as K,F as V,p as D,h as ie,A as _,G as se,H as ne,I as oe,a as R,r as y,x as c,J as B,K as C,O as U,M as P,y as ae,k as Z,W as ee,R as E,j as q,e as Y,q as ce,l as M,T as le}from"./index-C7cBUxcm.js";import{n as p,c as g,o as m,r as d}from"./if-defined-BZZvwuus.js";import{D as ue,T as de}from"./index-ByFbqkf3.js";import"./index-1n0bcWj9.js";import"./index-C4ysMPVG.js";import"./index-KuZ4KIt7.js";import"./index-BMBGHnmc.js";import"./index-Cpmm-uH6.js";import"./index-Cq19HH4d.js";import"./index-C_mUWead.js";import"./index-Ctux_Cuu.js";import"./index-B70JzZ_T.js";const N={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},F={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},pe={providers:J,selectedProvider:null,error:null,purchaseCurrency:N,paymentCurrency:F,purchaseCurrencies:[N],paymentCurrencies:[],quotesLoading:!1},l=re(pe),u={state:l,subscribe(s){return oe(l,()=>s(l))},subscribeKey(s,e){return ne(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=D.state.activeChain===ie.CHAIN.SOLANA?"SOL":"USDC",t=_.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",se),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||F,l.purchaseCurrency=s.purchaseCurrencies[0]||N,await V.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await V.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=J,l.selectedProvider=null,l.error=null,l.purchaseCurrency=N,l.paymentCurrency=F,l.purchaseCurrencies=[N],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},he=R`
  :host {
    width: 100%;
  }
